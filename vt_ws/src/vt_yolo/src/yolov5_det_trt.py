...
class YoLov5TRT(object):
    ...
    def infer(self, raw_image_generator):
        ...
        for i in range(self.batch_size):
            ...
            #     )
            # print(result_boxes)
            # self.result_boxes.append(result_boxes)
            # self.result_scores.append(result_scores)
            # self.result_classid.append(result_classid)
...
if __name__ == "__main__":
    ...
    engine_file_path = "../model/yolov5n7.engine"
