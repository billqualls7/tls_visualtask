...
LastEditTime: 2024-03-01 22:02:02
...
class VideoCapture:
    ...
    def __init__(self, camera_id, half_img=False):
        """默认640*480"""
...
'''
class USBCamera:
    def __init__(self,video_device, half_img=False):
        ...
        self.cap = VideoCapture(self.video_device, half_img=half_img) 



    # def update_resolution(self, width, height):
    #     """更新摄像头的分辨率设置"""
    #     self.cap.update_resolution(width, height)
        
    def usb_camera_read(self):
        return self.cap.read()
    
    def usb_camera_close(self):
        self.cap.terminate()
...
if __name__ == "__main__":        
    # 测试自定义VideoCapture类
    cap = VideoCapture(0,half_img=True)
    while True:
        t0 = time.time()
        frame = cap.read()
        # print(frame.shape)
